...
public class MyCrossoverOperator
  ...
  public void operate(final Population a_population,
    ...
    System.out.println("-> Performing " +  numCrossovers + " crossover operations...");  
    ...
    for (int i = 0; i < numCrossovers; i++) {
      ...
      // ---------------------------
      if (MSPolicy.DEBUG)
    	  System.out.println(" ... between " + Monitor.chromosomeToString(firstMate) + " and" +  Monitor.chromosomeToString(secondMate));
  ...
  public int compareTo(final Object a_other) {
    ...
    MyCrossoverOperator op = (MyCrossoverOperator) a_other;
